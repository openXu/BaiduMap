...
public class GroundOverlayActivity extends AppCompatActivity implements MKOfflineMapListener {
...
//        39.803326, 116.187119
    ...
    private void setGroundOverlay(BaiduMap mBaiduMap){
        //定义Ground的显示地理范围
        LatLng southwest = new LatLng(39.807404, 116.1842);
        LatLng northeast = new LatLng(39.801008, 116.189522);
