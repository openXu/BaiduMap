...
public class GroundOverlayActivity1 extends AppCompatActivity implements MKOfflineMapListener {
...
//        39.803326, 116.187119
    ...
    private void setGroundOverlay(BaiduMap mBaiduMap){
        //定义Ground的显示地理范围
        LatLng southwest = new LatLng(39.807081, 116.180894);
        LatLng northeast = new LatLng(39.801303, 116.191377);
        ...
        BitmapDescriptor bdGround = BitmapDescriptorFactory
                .fromResource(R.drawable.ground_overlay_1);
         //定义Ground覆盖物选项
